...
<%@page import="org.tfl.dao.OTPDAO"%>
<%
...
<body>
 ...
 --%>
		<div id="getActiveKey" class="settingmsg">
			Active key for Google Authenticator
			<%=request.getAttribute("activeKey")%>
		</div>
		...
		<form method="POST" autocomplete="off" accept-charset="utf-8"
			...
			<ul class="form-ul">
				...
				<li>
					...
					</div> <input type="text" required name="totp" size="25">
				</li>
